...
- **에디터**: [테마 에디터](https://admin.shopify.com/store/nanugi/themes/158823317721/editor)  
...
`main` 브랜치에 푸시하면 자동으로 테마(158823317721)에 배포됩니다.
...
2. **Environment에 Secrets 추가**  
   ...
   | `SHOPIFY_THEME_ID` | 배포할 테마 ID. 예: `158823317721` |
