...
[GitHub Actions] ① 저장소 체크아웃
         ...
         ↓
[Shopify] 지정한 테마(159722602713)에 파일 반영
```
...
| `SHOPIFY_THEME_ID` | `159722602713` | 배포할 테마 ID (에디터 URL에 포함) |
...
배포가 성공하면 지정한 테마(159722602713)에 변경 사항이 반영됩니다.  
테마 에디터: [Nanugi Studio 테마 에디터](https://admin.shopify.com/store/nanugi/themes/159722602713/editor)
