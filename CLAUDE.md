# CLAUDE.md — DWSTUDIO-TheBarberSpot
...
- **테마 ID**: 153363710141
- **테마 에디터**: https://admin.shopify.com/store/thebarberspot/themes/153363710141/editor
...
- Environment: `shopify-thebarberspot`

### 콘텐츠/설정 변경 (테마 에디터)
- 클라이언트/디자이너가 Shopify 테마 에디터에서 직접 수정
- 변경 사항이 "Update from Shopify for theme DWSTUDIO-TheBarberSpot/main" 커밋으로 자동 동기화됨
